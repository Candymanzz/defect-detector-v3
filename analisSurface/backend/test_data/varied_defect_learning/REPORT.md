...
- Допустимые варианты: **67/72** распознаны как ГОДЕН.
...
|---|---|---|---|---|---:|
| `ellipse` | `ellipse` | `small_70` | ГОДЕН | БРАК | — |
| `ellipse` | `ellipse` | `small_45` | ГОДЕН | БРАК | — |
| `rectangle_chip` | `rectangle_chip` | `two` | ГОДЕН | БРАК | 0.9390 |
| `irregular_blob` | `circle` | `foreign_shape` | БРАК | ГОДЕН | 0.9026 |
