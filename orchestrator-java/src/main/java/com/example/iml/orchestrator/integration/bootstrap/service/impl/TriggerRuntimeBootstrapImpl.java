...
public final class TriggerRuntimeBootstrapImpl extends AbstractBootstrapService implements TriggerRuntimeBootstrap {
    ...
    public TriggerRuntimeBootstrap.TriggerWireResult wire(TriggerWiringHost ctx) {
        IntegrationFeatureConfig.ContinuousInspectionConfig continuousInspection =
                BootstrapInspectionFeatures.continuousInspection(ctx.integration());
        ...
        if (inspectionTriggerConfig.ioInput().di3Only()) {
            ...
            if (BootstrapInspectionFeatures.devAutoTriggerStub(ctx.integration()).enabled()) {
    ...
    private void wireIntervalFlash(TriggerWiringHost ctx) {
