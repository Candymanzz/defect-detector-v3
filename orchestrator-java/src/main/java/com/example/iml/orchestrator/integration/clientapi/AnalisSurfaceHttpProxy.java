 ...
 */
public final class AnalisSurfaceHttpProxy {

    private static final HttpClient CLIENT = HttpClient.newBuilder()
            .connectTimeout(Duration.ofSeconds(15))
            .build();

    private AnalisSurfaceHttpProxy() {
    }
    ...
    public static void forward(HttpExchange ex, String baseUrl, String exchangePath) throws IOException {
        ...
        try {
            ...
            sendJsonError(ex, 502, "analisSurface proxy interrupted");
        } catch (Exception e) {
            sendJsonError(ex, 502, "analisSurface proxy: " + e.getMessage());
        }
    }
