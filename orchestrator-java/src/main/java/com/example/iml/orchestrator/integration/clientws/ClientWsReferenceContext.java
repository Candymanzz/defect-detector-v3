...
/**
 * In-memory контекст эталонов и FP (Фаза 2–5). Без persist на диск; после рестарта процесса пуст.
 */
public final class ClientWsReferenceContext {
    ...
    /** Пакет эталонов принят и прошёл валидацию (не путать с persist на диск). */
