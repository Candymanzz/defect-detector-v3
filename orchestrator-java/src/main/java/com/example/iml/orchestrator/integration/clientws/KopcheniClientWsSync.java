...
/**
 * Заголовки stdio-команд kopcheni (Фаза 5): синхронизация пакета эталонов, FP, активного ракурса.
 */
public final class KopcheniClientWsSync {

    private KopcheniClientWsSync() {
    }
