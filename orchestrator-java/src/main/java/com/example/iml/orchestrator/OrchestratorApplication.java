...
import com.example.iml.orchestrator.integration.bootstrap.IntegrationBootstrap;
...
/**
 * Сценарий запуска оркестратора: загрузка YAML-конфига, отчёт в лог и запуск интеграции.
 */
public final class OrchestratorApplication {
    ...
    private final YamlFileConfigLoader configLoader;
    private final StartupConfigurationReporter startupReporter;
    private final IntegrationBootstrap integrationBootstrap;

    public OrchestratorApplication(YamlFileConfigLoader configLoader, StartupConfigurationReporter startupReporter) {
